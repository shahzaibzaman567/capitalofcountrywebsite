function malom(event) {
    ...
    for (let i = 0; i < countriesAndCapitals.length; i++) {
      if (countriesAndCapitals[i].country.toLowerCase() === countryInput) {
        capitalOutput.value = countriesAndCapitals[i].capital;
        paragraph.innerText = `The capital of ${countriesAndCapitals[i].country} is ${countriesAndCapitals[i].capital}.`;
        paragraph.classList.add("Vailed");
    ...
    if (!found) {
      capitalOutput.value = "";
      paragraph.innerText = "Please enter a valid country name.";
      paragraph.classList.add("Error");
      paragraph.classList.remove("Vailed");
    }
